...
TOOL_DESCRIPTION = (
    ...
    "\n"
    "Use this whenever the user names a food and you don't already have its "
    "node_id. Results are ranked: rank-1 is the system's best guess. Each "
    "result includes the node's parent chain so you can confirm category.\n"
    "\n"
